...
`difficulty level`
 باید مقداری بین ۱ تا ۵ باشد. وقتی حساب کاربری جدید ساخته می‌شود، به صورت پیش‌فرض میزان سختی روی مقدار ۳ است). تغییر میزان سختی بازی، این موارد ضریب می‌گیرند:
...
استفاده 
خواهد بود.
. در ادامه توضیحات، همواره فرض می‌شود میزان سختی ۳ است، مگر آنکه خلاف آن گفته شود.
