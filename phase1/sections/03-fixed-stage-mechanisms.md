...
## زمین بازی
بازی اصلی در پنچ ردیف و ۹ ستون شکل میگیرد. مگر اینکه در تنظیمات مرحله طور دیگری گفته شده باشد. هر کدام این خانه‌ها می‌تواند انواع مختلفی خواهد داشت (در ادامه توضیحات داک، درمورد این فصل‌ها بیشتر توضیح داده خواهد شد).
...
## سکه و الماس و گلدان
هر زامبی هنگام کشته شدن، به احتمال ده درصد احتمال دارد که 1 الماس یا 50 سکه یا یک گلدان (مربوط به گلخانه) بیندازد. در این صورت، باید پیغام مناسب به صورت زیر چاپ شود:
```
...
## چاپ بازی
با دستور زیر شرایط کنونی بازی به صورت ترمینالی چاپ می‌شود. در هر خانه باید مشخص شود که آیا زامبی وجود دارد، گیاه وجود دارد و به طور کلی شرایط فعلی نشان داده شود. همچنین شکل زمین‌های متفاوت (آب، قبر، کلاسیک یخزده) باید متمایز باشد همچنین ابتدا ذکر شود که موج چندم هستیم چند غذا داریم، چند خورشید داریم و ... همچنین باید مشخص شود که آیا در هر ردیفماشین چمنزنی استفاده شده است تا به حال یا خیر. توجه کنید که چون حرکت زامبی‌ها به صورت پیوسته است، مختصات زامبی‌ها در راستای افقی می‌تواند عددی اعشاری باشد، اما مختصات گیاهان همواره عددی صحیح است.
