...
# [زامبی‌‌ها](../main.md#فهرست-مطالب)

می‌توانید در
[این جا](https://my.sharif.edu/s/ASib93TEPAaotbw)
مشخصات کل زامبی‌ها را مشاهده کنید. جزئیات هرکدام در بخش زیر آمده است.
زمابی‌های دارای رنگ آبی، امتیازی هستند.
...
- یک Imp پشت این زامبی‌ها قرار دارد. هر وقت زامبی غول‌پیکر به نصف جان خودش برسد، imp را از پشت خود پرتاب می‌کند و به ستون سوم (از چپ) از سطر خودش می‌اندازد
...
- با سرعت زیادی وارد زمین میشود. در حین دویدن، اگر به یک گیاه یا زامبی هیپنوتیزم شده برخورد کند، یک ضربه مهلک به او وارد میکند و درجا آن را از بین میبرد
...
<h4 style="color: cyan;">زامبی آرکید (arcade zombie)</h4>

- این زامبی دستگاه های Arcade روی زمین را به جلو هل میدهد. این دستگاه‌ها (و خود این زامبی) به اندازه زامبی سر سطلی سلامتی دارند.
...
- در صورتی که گیاهی را در شعاع 4 خانه ای خود ببیند، شروع میکند به دزدیدن خورشید های ذخیره شده توسط بازیکن و برای 5 ثانیه این کار را ادامه میدهد
- هر ثانیه 25 خورشید میدزدد
...
- بعد از انفجار، دینامیت به انتهای سطر (کنار خانه) پرتاب می‌شود و خلاف جهت باقی زامبی‌ها شروع به حرکت و خوردن گیاه‌ها می‌کند
...
- پیانو می‌نوازد و حین نواختن پیانو، زامبی‌ها هر چند ثانیه یک بار به صورت تصادفی سطر خود را با یکی از سطرهای همسایه جابه‌جا می‌کنند
...
- این زامبی یک دبه را جلوی خودش هل میدهد (مانند Troglobite و Arcade Zombie)
- اگر زامبی قبل از خراب شدن دبه (توسط گیاهان یا زامبی‌های هیپنوتیزم‌شده) بمیرد، دبه سر جای خودش باقی می‌ماند. تیرها از آن رد نمی‌شوند ولی زامبی‌ها چرا.
...
- تیر باقی گیاهان از گیاهان یخ زده عبور نمیکند، مگر lobberها
...
<h4 style="color: cyan;"> تروگلوبایت (Troglobite)</h4>
...
<h4 style="color: cyan;"> ماهیگیر (Fisherman Zombie)</h4>

- در راست ترین ستون زمین ثابت میماند
- هر چند ثانیه یک بار، یک گیاه از سطر خود را قلاب میکند و یک خانه به جلو میاورد (خانه سمت راست گیاه باید خالی باشد)
...
<h4 style="color: cyan;">ژانگولر (Juggler / Jester Zombie)</h4>
...
- اگر تیر هایی که به سمت گیاهان برگردانده میشوند، یخی باشند، سبب یخ زدن گیاهان میشوند (اثری مشابه پرتابه های زامبی شکارچی (hunter))
...
####
<h4 style="color: cyan;">جادوگر (Wizard Zombie)</h4>
...
- گیاهانی که گربه شدند، تا زمان کشته شدن جادوگری که آنها را تلسم کرده گربه میماند و بعد آن به حالت عادی بازمیگردند
...
<h4 style="color: cyan;"> پادشاه (King)</h4>

- در راست ترین ستون قرار میگیرد و حرکت نمیکند
- هر چند ثانیه یک بار، یکی از زامبی‌های ساده‌ی اطراف خود را به شوالیه تبدیل می‌کند (به آن‌ها کلاه‌خود و شانه‌بند می‌دهد)
